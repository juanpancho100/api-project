...
$cliente = new cliente();
$resultado = $cliente->MostrarClientes();
    ...
    foreach ($resultado->fetchAll() as $k => $item) {
        echo "<tr>
                ...
                <td class='tabla_celda'><form method='post' action='clases/Clientes_Añadir.php'>
                        <input type='submit' name='submit' value='Añadir'>
                    </form>
                </td>
                <td class='tabla_celda'><form method='post' action='Eliminar_Clientes.php'>
                        <input type='hidden' name='id_cli' value='".$item["id_cli"]."'>
                        <input type='submit' name='submit' value='Eliminar'>
                    </form>
                </td>
                <td class='tabla_celda'><form method='post' action='Actualizar_Clientes.php'>
                        <input type='hidden' name='id_cli' value='".$item["id_cli"]."'>
